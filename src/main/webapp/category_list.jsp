...
<div class=" page-content clearfix">
  <div id="products_style">
    <div class="border clearfix">
       <span class="l_f">
        <a href="category_add.jsp" title="添加分类" class="btn btn-warning Order_form"><i class="icon-plus"></i>添加分类</a>
...
<%--                </a>--%>
                <a title="编辑" href="CategoryQueryServlet?cid=${category.categoryId}" class="btn btn-xs btn-info" >
                  <i class="icon-edit bigger-120"></i>
                </a>
                <a title="删除" href="javascript:;"  onclick="category_del(this,${category.categoryId})" class="btn btn-xs btn-warning" >
...
<script type="text/javascript">
  ...
  function category_del(obj,id){
    layer.confirm('确认要删除当前分类吗？',function(index){
      ...
      $.post("CategoryDeleteServlet",{cid:id},function(res){
        //2.对删除操作返回的结果进行处理
        if(res.code == 1000 ){
          //a.删除成功
          //移出表格中的当前行（JS处理前端效果）
