...
<div class="clearfix" id="add_picture">
  <div class="page_right_style" style="left: 0px;">
    <div class="type_title">添加分类</div>
    <div style="width: 70%; margin: auto;">
      <form action="CategoryAddServlet" method="post" enctype="multipart/form-data" class="form form-horizontal" id="form-article-add">
        <div class=" clearfix cl"  style="margin-top: 30px;">
          <label class="form-label col-2">分类名称：</label>
          <div class="formControls col-10"><input type="text" class="input-text" style="height: 35px;"  name="categoryName"></div>
        </div>
        <div class=" clearfix cl" style="margin-top: 30px;">
          <label class="form-label col-2">分类图片：</label>
          <div class="formControls col-10"><input type="file" class="input-text" style="height: 35px;"  name="categoryIcon"></div>
        </div>
        <div class="clearfix cl" style="margin-top: 30px;">
