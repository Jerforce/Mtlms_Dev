      ...
      <div class="Competence_add">
        <div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 角色名称 </label>
          <div class="col-sm-9">
            ...
            <input type="text" id="form-field-1"  name="roleName" class="col-xs-10 col-sm-5" value="${role.roleName}">
          </div>
        </div>
        <div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 角色描述 </label>
          <div class="col-sm-9">
            <textarea name="roleDesc" class="form-control" id="form_textarea"  onkeyup="checkLength(this);">${role.roleDesc}</textarea>
    ...
    <div class="Assign_style">
      ...
      <div class="Select_Competence">
        <dl class="permission-list">
          <dt>
            <label class="middle"><input name="user-Character-0" class="ace" type="checkbox" id="id-disable-check"><span class="lbl">全部菜单</span></label>
          </dt>
          <dd>
                    ...
                    <label class="middle">
                      <c:choose>
                        <c:when test="${menu1.haveMenu}">
                          <input type="checkbox" value="${menu1.menuId}" class="ace"  name="menuId" id="id-disable-check" checked>
                        </c:when>
                        <c:otherwise>
                          <input type="checkbox" value="${menu1.menuId}" class="ace"  name="menuId" id="id-disable-check">
                        </c:otherwise>
                      </c:choose>
                        ...
                        <label class="middle">
                          <c:choose>
                            <c:when test="${menu2.haveMenu}">
                              <input type="checkbox" value="${menu2.menuId}" class="ace" name="menuId" id="user-Character-0-0-0" checked>
                            </c:when>
                            <c:otherwise>
                              <input type="checkbox" value="${menu2.menuId}" class="ace" name="menuId" id="user-Character-0-0-0">
                            </c:otherwise>
                          </c:choose>
