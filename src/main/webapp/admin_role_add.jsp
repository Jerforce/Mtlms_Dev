    ...
    <div class="left_Competence_add">
      ...
      <div class="Competence_add">
        ...
        <div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 角色描述 </label>
          <div class="col-sm-9">
            <textarea name="roleDesc" class="form-control" id="form_textarea" placeholder="" onkeyup="checkLength(this);"></textarea>
    ...
    <div class="Assign_style">
      ...
      <div class="Select_Competence">
        <dl class="permission-list">
          <dt><label class="middle"><input name="user-Character-0" class="ace" type="checkbox" id="id-disable-check">
            <span class="lbl">所有权限</span></label>
          </dt>
          <dd>
            <c:forEach items="${menu1List}" var="menu1" >
              <%-- 如果一级菜单中的二级菜单不为空，才显示此一级菜单  --%>
              <c:if test="${menu1.childMenus != []}">
                <dl class="cl permission-list2">
                  <dt>
                    <label class="middle">
                      <input type="checkbox" value="${menu1.menuId}" class="ace" name="menuId" id="id-disable-check1">
